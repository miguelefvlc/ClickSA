        ...
        <div style="flex-grow: 1; display: flex; flex-direction: column;">
            ...
            <div class="eval-tools">
                ...
                <div id="criteria-container-${actId}" style="display: none; align-items: center; flex-direction: row; gap: 6px; flex-wrap: wrap; position: relative;">
                    <div class="btn-add-criteria btn-add-crit" title="Vincular Indicador d'Assoliment (IA)"><i class="fa-solid fa-link"></i></div>
                </div>
            </div>
        </div>`;
...
export function showCriteriaDropdown(btn, containerId, targetType) {
    ...
    if (tags.length === 0) {
        let errMsg = targetType === 'CA' 
            ...
            : "No has seleccionat cap Indicador d'Assoliment a l'apartat 2.";
...
export function addObjectiveDidactic() {
    ...
    if (!code || !desc) {
        alert("Has de posar un codi i una descripció per a l'Indicador d'Assoliment.");
        return;
    }
